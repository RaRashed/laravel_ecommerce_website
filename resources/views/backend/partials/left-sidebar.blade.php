 <aside class="main-sidebar sidebar-dark-primary elevation-8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('images/rashed.jpg')}}" class="img-circle elevation-2" width="50px" alt="User Image">
        </div>
        <div class="info">
      ...
      <!-- Sidebar Menu -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ml-3">
                <a href="{{route('backend.brands')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ml-3">
                <a href="{{route('backend.divisions')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ml-3">
                <a href="{{route('backend.districts')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ml-3">
                <a href="{{route('backend.orders')}}" class="nav-link">
