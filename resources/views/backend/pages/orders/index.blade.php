          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class=".text-*-center"><center> Manage Orders </center></h3>
              </div>
   ...
   <tr> 
    ...
    <p>
      ...
      @else
       ...
       <button type="button" class="btn btn-danger btn-sm">Un Paid</button>
    ...
    <td>
       <a href="{{route('backend.orders.show',$order->id)}}" class="btn btn-info">View Order</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{route('backend.order.delete',$order->id)}}"  >
          @csrf
